...
decode(_) ->
  ...
  ?assertEqual(
    ...
    otel_propagator_xray:decode(<<"Root=1-5759e988-bd862e3fe1be46a994272793;Parent=53995c3f42cd8ad8;Sampled=0">>)
  ),
  ?assertEqual(
    SpanCtx#span_ctx{trace_id=TraceId, trace_flags=1},
    otel_propagator_xray:decode(<<"Root=1-5759e988-bd862e3fe1be46a994272793;Sampled=1;Lineage=a87bd80c:1|68fd508a:5|c512fbe3:2">>)
  ),
  ok.
